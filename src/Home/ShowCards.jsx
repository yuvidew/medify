...
export const ShowCards = () => {
  ...
  return (
    <div className=' container bg-gradient-to-tr h-[39rem] from-[#E7F0FF] to-[#E8F1FF78] p-5 flex items-center justify-center flex-col'>
        <h1 className=' text-[2rem] text-[#1B3C74] font-medium mt-[1.5rem]'>Find by specialisation</h1>

      <div className=' grid w-[80%] m-auto mt-10 grid-cols-4 gap-5'>
        {cartInfo.map((ele) => (
